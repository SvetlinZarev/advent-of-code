...
rock to move into the walls, floor, or a stopped rock, the movement instead does
not occur. If a downward movement would have caused a falling rock to move into
...
Rock falls 1 unit, causing it to come to rest (step 2):
|...#...|
|..###..|
|...#...|
|..####.|
...
the tower will be after `1_000_000_000_000` rocks have stopped! Only then will
