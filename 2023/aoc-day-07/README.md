...
the strength of each hand. A hand consists of five cards labeled one
...
2. The other cards stay in the same
...
treated as `J`, not the card it's pretending to be: `JKKK2` is weaker
